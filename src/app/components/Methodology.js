                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-5">
                            ...
                            <p className="text-slate-400 max-w-xl text-[15px]">The foundation of this project was based on a strong theoretical background mainly related to teaching and learning techniques, and learning analytics. We adopted a systematic approach by starting with an extensive search for scholarly work to gather, evaluate, and synthesize relevant literature on the subject.</p>
                            <p className="text-slate-400 max-w-xl text-[15px] mt-6">On the theoretical aspect, the cognitive levels of Bloom’s Taxonomy were utilized to categorize the three learning levels as beginner, intermediate, and advanced. Afterward, the teaching and learning frameworks identified from past scholarly work were analyzed to establish a theoretical mapping between cognitive levels, learning levels, and lesson learning outcomes.</p>
                            <p className="text-slate-400 max-w-xl text-[15px] mt-6">On the technical aspect, the established theoretical mappings were used to formulate the necessary prompt templates. This also included leveraging the technique of Retrieval Augmented Generation (RAG) to utilize contextually relevant information from a knowledge base. Eventually, the powerful combination of the GPT-4o-mini model and LangChain framework was used for the synthesis and technical simulation of these teaching-learning frameworks. Similarly, a Learning Analytics Dashboard (LAD) was also developed with the ability to generate custom visualizations to aid in monitoring this online learning approach.</p>

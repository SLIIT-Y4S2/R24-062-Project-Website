                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-3 grid-cols-1 items-center">
                    <div className="lg:col-span-3 md:text-start text-center">
                        <Link href="#" className="text-[22px] focus:outline-none">
                            <Image src="/images/soloscholar_logo.png" width={150} height={100} className="mx-auto md:me-auto md:ms-0 dark:hidden" alt=""/>
                            <Image src="/images/soloscholar_logo_dark.png" width={150} height={100} className="mx-auto md:me-auto md:ms-0 hidden dark:inline-block" alt=""/>
                        </Link>
                    </div>

                    <div className="lg:col-span-5 text-center mt-6 md:mt-0">
                        <p className="mb-0">© {new Date().getFullYear()} SoloScholar. Design & Develop with {""} <i className="mdi mdi-heart text-red-600"></i> by <Link href="https://SoloScholar.com/" target="_blank" className="text-reset">SoloScholar Team</Link>.</p>
                    </div>
